...
| Feature | Status | Target phase |
|---|---|---|
| Text tool | ✅ editable first-class Text Layer | V0.6.2/V0.6.7 |
| Font / size / weight / alignment / line & letter spacing / outline | ✅ | V0.6.7 |
| Speech balloons | ✅ ellipse/rounded body + editable straight tail | V0.6.7 |
| Panel/frame divider | ✅ rows/columns/margin/gutter/stroke | V0.6.7 |
| Comic guides | 🟡 straight panel-grid guide foundation; arbitrary polygon frames later | V0.6.7 |
| Screen tones | ✅ editable dots/lines frequency/angle/density | V0.6.7 |
| Speed lines / focus lines | ✅ deterministic editable effect layers | V0.6.7 |
...
| Image material / texture | ✅ PNG/JPEG/WebP import + editable transform | V0.6.7 |
| Pattern / tone material | ✅ repeat modes + screen-tone layer | V0.6.7 |
...
| SVG export | ⬜ | V0.9 |
| App project format | ⬜ | V0.9 |
| Autosave / recovery | ⬜ | V0.6.9/V0.9 |
